...
- Bei Videostillstand ein zusätzlicher Keyframe-Versuch. **Neu verbinden** startet auf Wunsch einen neuen Versuch. **Beenden** bleibt beendet, auch nach Rückkehr des Internets. Eine fehlgeschlagene Verbindung wird nicht durch fortlaufendes Neuladen des Players unterbrochen.
...
Beide Seiten verwenden denselben offiziellen [VDO.Ninja-GitHub-Mirror](https://steveseguin.github.io/vdo.ninja/) und denselben Passwort-Salt. VDO lädt seine aktuelle öffentliche TURN-Serverliste für Verbindungen über unterschiedliche Netze; direkte Verbindungen bleiben möglich. Der alte feste Servereintrag wurde entfernt, nachdem ein Relay-Test damit keine Verbindung aufbauen konnte. TURN vermittelt eine einzelne Verbindung und verteilt nicht einen Stream an beliebig viele Zuschauer. Die externen Dienste können ausfallen oder den Start verzögern.
